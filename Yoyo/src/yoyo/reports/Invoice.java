...
public class Invoice extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5.setBackground(new java.awt.Color(246, 245, 249));

        jPanel7.setOpaque(false);

        jLabel32.setFont(new java.awt.Font("Segoe UI Black", 0, 20)); // NOI18N
        jLabel32.setForeground(new java.awt.Color(30, 33, 82));
        jLabel32.setText("YOYO FURNITURE INVOICE");

        jLabel33.setForeground(new java.awt.Color(30, 33, 82));
        jLabel33.setText("No. 15, Jalan Mimpi Indah,");

        jLabel34.setForeground(new java.awt.Color(30, 33, 82));
        jLabel34.setText("Desa Cahaya Harapan,");

        jLabel35.setForeground(new java.awt.Color(30, 33, 82));
        jLabel35.setText("Selangor");

        jLabel36.setForeground(new java.awt.Color(30, 33, 82));
        jLabel36.setText("43300, Seri Kembangan,");

        jLabel37.setForeground(new java.awt.Color(30, 33, 82));
        jLabel37.setText("yoyofurniture@gmaill.com");

        jLabel38.setForeground(new java.awt.Color(30, 33, 82));
        jLabel38.setText("+6012-356789");
