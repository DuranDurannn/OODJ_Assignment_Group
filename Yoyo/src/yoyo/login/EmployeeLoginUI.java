...
import yoyo.actor.admin.menu.AdminDashboardUI;
import javax.swing.JOptionPane;
import yoyo.actor.admin.menu.AdminDashboardUI;
import yoyo.actor.officer.menu.OfficerDashboardUI;
import yoyo.actor.salesperson.menu.SalespersonDashboardUI;
...
public class EmployeeLoginUI extends javax.swing.JFrame {
    ...
    private void login_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_login_btnActionPerformed
        ...
        switch (Authentication.autheticateEmployee(userEmail, userPassword)) {
            case "S":{
                    SalespersonDashboardUI mainMenu = new SalespersonDashboardUI();
            ...
            case "O": {
                    OfficerDashboardUI mainMenu = new OfficerDashboardUI();
                    mainMenu.setVisible(true);
                    mainMenu.pack();
                    mainMenu.setLocationRelativeTo(null);
                    this.dispose(); // Close the Login frame
            ...
            case "A": {
                    AdminDashboardUI mainMenu = new AdminDashboardUI();
                    mainMenu.setVisible(true);
                    mainMenu.pack();
                    mainMenu.setLocationRelativeTo(null);
                    this.dispose(); // Close the Login frame
